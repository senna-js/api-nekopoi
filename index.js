...
async function getDetailAnime(url) {
  ...
  const score = $("div.colinfo").find("ul.infolist span:nth-child(3)").text();
  const duration = $("div.colinfo").find("ul.infolist span:nth-child(4)").text();
  const released = $("div.colinfo").find("ul.infolist span:nth-child(5)").text();
  const producers = $("div.colinfo").find("ul.infolist span:nth-child(6)").text();
